...
type TabKey = "index" | "maintenance" | "payments" | "complaints" | "settings";

const ITEMS: { name: TabKey; label: string; icon: keyof typeof Ionicons.glyphMap }[] = [
  { name: "index", label: "Dashboard", icon: "home" },
  { name: "maintenance", label: "Maintenance", icon: "receipt" },
  { name: "payments", label: "Payments", icon: "card" },
  { name: "complaints", label: "Complaints", icon: "alert-circle" },
...
export function ResidentTabBar({ active, navigation }: ResidentTabBarProps) {
